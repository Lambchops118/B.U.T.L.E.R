...
Follow [`AGENTS.md`](AGENTS.md). For awareness/memory work, read these first:

1. [`docs/awareness-memory/IMPLEMENTATION_STATUS.md`](docs/awareness-memory/IMPLEMENTATION_STATUS.md)
