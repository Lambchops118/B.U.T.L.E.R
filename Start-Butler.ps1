# Start the whole Butler stack from one place.
#
#   .\Start-Butler.ps1            # open the launcher GUI
#   .\Start-Butler.ps1 --no-gui   # start everything headless in this console
#
# Any arguments are passed straight through to `python -m butler.launcher`.
