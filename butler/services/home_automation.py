...
TIMEZONE_NAME = os.getenv("BUTLER_TIMEZONE", "").strip()
OPEN_WEATHER_API_KEY = os.getenv("OPEN_WEATHER_API_KEY", "").strip()
WEATHER_LOCATION = os.getenv("BUTLER_WEATHER_LOCATION", "").strip()
WEATHER_UNITS = os.getenv("BUTLER_WEATHER_UNITS", "imperial").strip().lower()
...
def get_current_weather(location: str = "") -> str:
    ...
    if not requested_location:
        raise ValueError("No weather location configured. Set BUTLER_WEATHER_LOCATION or pass a location.")
