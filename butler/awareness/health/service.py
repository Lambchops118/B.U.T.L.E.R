...
from butler.awareness.db.migrate import expected_head_revision
        ...
        if missing:
            return ComponentStatus(
                ...
                detail=(
                    ...
                    "'python -m butler.awareness migrate' (extensions are created by the "
                ...
                if not has_table.scalar_one():
                    return ComponentStatus(
                        ...
                        detail=(
                            ...
                            "'python -m butler.awareness migrate'"
                        ),
