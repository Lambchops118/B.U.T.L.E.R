...
from butler.awareness.context.broker import Candidate, _age_text, _iso
from butler.awareness.history.briefing import BriefingHistory
from butler.awareness.history.telemetry import QueryBoundsError
from butler.awareness.logging_utils import get_logger
from butler.awareness.briefing.speech import event_text, novelty_text, short_text, transition_text
...
class BriefingAssembler:
    ...
    async def assemble(self, history: BriefingHistory, kind: str, now: datetime) -> dict[str, Any]:
        ...
        from butler.awareness.briefing.feedback import apply_preferences
