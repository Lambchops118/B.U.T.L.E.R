...
from butler.awareness.db.models import CurrentState, Source, SourceHealthHistory, StateTransition
from butler.awareness.logging_utils import get_logger

logger = get_logger("butler.awareness.state.freshness")
        ...
        rows = (
            await connection.execute(
                ...
                .where(
                    ...
                    # and announcing "Butler is offline" on the next startup
