...
EVENT_SPEECH = {
    ...
    "person.interaction.started": "An earlier interaction with Butler started.",
    "person.interaction.ended": "An earlier interaction with Butler ended.",
}
...
def label(value, fallback="device"):
    ...
    if len(value) > 60 or not re.fullmatch(r"[\w .'-]+", value):
        return fallback
    return {"owner": "your presence", "talos": "Butler"}.get(value, value)
