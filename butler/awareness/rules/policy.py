...
Policies live in a TOML file (``BUTLER_AWARENESS_RULES_PATH``, default
``butler/awareness/rules/rules.toml``) validated into the typed models below —
...
from butler.awareness.db.models import SEVERITIES
