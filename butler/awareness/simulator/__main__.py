"""Simulator CLI.
    ...
    python -m butler.awareness.simulator --scenario suite
    python -m butler.awareness.simulator --scenario overflow --host 127.0.0.1 --port 1885
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="butler.awareness.simulator", description=__doc__)
