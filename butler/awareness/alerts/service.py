...
Quiet hours (``BUTLER_AWARENESS_QUIET_HOURS``, e.g. ``22:00-07:00`` local
...
from butler.awareness.db.models import Alert, AlertEvent, AttentionItem, OutboxItem
from butler.awareness.logging_utils import get_logger

logger = get_logger("butler.awareness.alerts")
