...
class StreamingSpeaker:
    ...
    def speak_stream(self, text_deltas: Iterable[str]) -> str:
        ...
        synth_thread = threading.Thread(target=synth_worker, name="butler-tts-synth", daemon=True)
        playback_thread = threading.Thread(target=playback_worker, name="butler-tts-play", daemon=True)
        synth_thread.start()
